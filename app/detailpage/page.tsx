...
export default function DetailPage() {
  return (
    <div className="text-white">
          ...
          <div className="flex flex-col gap-8 sm:flex-row sm:gap-10 lg:gap-14">
            ...
            <div className="flex max-w-xl flex-col gap-5">
              ...
              <p className="text-sm leading-relaxed text-white/75 sm:text-base">
                ...
                shaken yet again by a shocking secret. Amid monstrous threats,
                she embarks on a globetrotting adventure to learn the truth about
                her family—and the mysterious organization known as Monarch.
              </p>
                ...
                {streamingPlatforms.map((platform) => (
                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm  leading-tight">{platform.name}</p>
                    </div>
                  </button>
                ))}
              </div>
      ...
      {/* SIMILAR MOVIES (separate section, no banner blending) */}
      <section className="bg-black">
        <div className="mx-auto container py-16">
          <MoviesRow title="Similar Movies" movies={similarMovies} />
        </div>
      </section>
    </div>
  );
